 ...
 */
export type EntityEnum = 'A' | 'B' | 'C' | 'D';
...
export type EntityUpdate = {
   ...
   * String Array Field
   */
  string_array_field?: Array<string> | null;
  /**
   * String Field
   */
 ...
 */
export type SimpleEntityCreate = {
  /**
   * Bool Field
   */
  bool_field?: boolean;
  enum_field?: SimpleEntityEnum;
  /**
   * Int Field
   */
  int_field: number;
 ...
 */
export type SimpleEntityEnum = 'A' | 'B' | 'C' | 'D';
 ...
 */
export type SimpleEntityUpdate = {
  /**
   * Bool Field
   */
  bool_field?: boolean | null;
  enum_field?: SimpleEntityEnum | null;
  /**
   * Int Field
   */
  int_field?: number | null;
...
export type GetEntitiesResponse =
  GetEntitiesResponses[keyof GetEntitiesResponses];
...
export type DeleteEntityResponse =
  DeleteEntityResponses[keyof DeleteEntityResponses];
...
export type GetSimpleEntitiesData = {
  body?: never;
  path?: never;
  query?: never;
  url: '/simple-entities/';
...
export type GetSimpleEntitiesResponses = {
  /**
   * Response Get Simple Entities
   *
   * Successful Response
   */
  200: Array<SimpleEntityRead>;
};

export type GetSimpleEntitiesResponse =
  GetSimpleEntitiesResponses[keyof GetSimpleEntitiesResponses];

export type CreateSimpleEntityData = {
  body: SimpleEntityCreate;
  path?: never;
  query?: never;
  url: '/simple-entities/';
};

export type CreateSimpleEntityErrors = {
  /**
   * Validation Error
   */
  422: HttpValidationError;
...
export type CreateSimpleEntityError =
  CreateSimpleEntityErrors[keyof CreateSimpleEntityErrors];

export type CreateSimpleEntityResponses = {
  /**
   * Successful Response
   */
  201: SimpleEntityRead;
};

export type CreateSimpleEntityResponse =
  CreateSimpleEntityResponses[keyof CreateSimpleEntityResponses];

export type DeleteSimpleEntityData = {
  body?: never;
  path: {
    /**
     * Simple Entity Id
     */
    simple_entity_id: number;
  };
  query?: never;
  url: '/simple-entities/{simple_entity_id}';
};

export type DeleteSimpleEntityErrors = {
  /**
   * Validation Error
   */
  422: HttpValidationError;
...
export type DeleteSimpleEntityError =
  DeleteSimpleEntityErrors[keyof DeleteSimpleEntityErrors];

export type DeleteSimpleEntityResponses = {
  /**
   * Successful Response
   */
  204: void;
...
export type DeleteSimpleEntityResponse =
  DeleteSimpleEntityResponses[keyof DeleteSimpleEntityResponses];

export type GetSimpleEntityData = {
  body?: never;
  path: {
    /**
     * Simple Entity Id
...
export type GetSimpleEntityErrors = {
  /**
   * Validation Error
   */
  422: HttpValidationError;
...
export type GetSimpleEntityError =
  GetSimpleEntityErrors[keyof GetSimpleEntityErrors];

export type GetSimpleEntityResponses = {
  /**
   * Successful Response
   */
  200: SimpleEntityRead;
};

export type GetSimpleEntityResponse =
  GetSimpleEntityResponses[keyof GetSimpleEntityResponses];

export type UpdateSimpleEntityData = {
  body: SimpleEntityUpdate;
  path: {
    /**
     * Simple Entity Id
     */
...
export type UpdateSimpleEntityErrors = {
  /**
   * Validation Error
   */
  422: HttpValidationError;
...
export type UpdateSimpleEntityError =
  UpdateSimpleEntityErrors[keyof UpdateSimpleEntityErrors];

export type UpdateSimpleEntityResponses = {
  /**
   * Successful Response
   */
  200: SimpleEntityRead;
