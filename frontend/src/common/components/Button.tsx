...
const buttonVariants = cva(
  ...
  ],
  {
    variants: {
      variant: {
        primary:
          "bg-blue-300 text-grey-100 hover:bg-blue-400",
        secondary:
          "bg-grey-200 text-grey-500 border border-grey-300 hover:bg-grey-300",
        tertiary:
          "bg-grey-100 text-grey-500 border border-grey-300 hover:bg-grey-150",
        textLink:
          "bg-transparent text-blue-300 hover:underline",
      },
      shape: {
        default: [
          "font-nunito font-bold text-h3",
