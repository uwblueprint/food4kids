"""Update Driver, Admin and Add User, SystemSettings

Revision ID: 988258439eae
Revises: 7af7d4689b08
Create Date: 2025-11-16 00:48:20.003510
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('drivers', sa.Column('address', sa.VARCHAR(length=255), autoincrement=False, nullable=False))
