...
# The rewrite itself (source "/api/**") lives in frontend/firebase.json on
# feat/deployment-setup (PR #210), not yet on main; tests/test_api_prefix.py
# pins the literal until it lands.
API_PREFIX = "/api"
