...
@lru_cache
def get_location_mapping_service() -> LocationMappingService:
    """Get location mapping service instance"""
    logger = get_logger()
    return LocationMappingService(logger)
...
def get_location_service() -> LocationService:
    ...
    location_mapping_service = get_location_mapping_service()
    return LocationService(logger, google_maps_client, location_mapping_service)
