...
ROUTE_POLICIES: dict[tuple[str, str], Policy] = {
    ...
    ("GET", "/drivers/{driver_id}/history/entries"): Policy.SELF_DRIVER_OR_ADMIN,
    # Mileage corrections are admin-only appends to the ledger — drivers
    # can no longer edit their own km.
